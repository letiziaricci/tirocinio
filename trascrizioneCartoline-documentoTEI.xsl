<?xml version="1.0" encoding="UTF-8"?>
    ...
    <xsl:template match="/">
             <tei:teiCorpus xmlns="http://www.tei-c.org/ns/1.0">
	              <tei:teiHeader>
                    <tei:fileDesc> <!-- contiene le informazioni relative al documento digitale-->
                      <tei:titleStmt> <!-- titolo e responsabili dell'edizione digitale -->
                        ...
                        <tei:respStmt>
                          ...
                          <tei:name type="comune">Comune di
                     ...
                     <tei:editionStmt> <!-- contiene informazion sull'edizione -->
                            ...
                            <tei:date when="2018">2018</tei:date>
				                  </tei:edition>
				                  <tei:respStmt>
                         ...
                         <respStmt>
                                ...
                                <persName ref="#pTC">Tommaso Castagneto</persName>
                        </respStmt>
                         <tei:respStmt>
                         ...
                         <tei:respStmt>
                           ...
                           <tei:persName>E. Ratti</tei:persName>
				                 </tei:respStmt>
                   </tei:editionStmt>
                   <tei:publicationStmt> <!-- contiene informazioni sulla pubblicazione e distribuzione del documento digitale -->
                    ...
                    <tei:date when="2019">2019</tei:date>
                    <tei:distributor>
					                 <tei:orgName>
						                     <tei:choice>
               ...
               <encodingDesc>
                  <p>
                      Check sintattico con xmllint e validazione con schema RNG.
                      Codifica seguendo il metodo "parallel-trascription".
                      Codifica di base rispettando le forme e le informazioni lessicali, la punteggiatura e la sillabazione del documento,
                      normalizzando il tutto per la codifica.
                      Con appositi attributi è stata specificata anche la resa grafica di alcuni elementi.
                  </p>
              </encodingDesc>
            </tei:teiHeader>
  ...
  <xsl:template match="text//salute">
    <tei:closer>
      <tei:s>
          ...
          <xsl:for-each select="tokenize($T,'\n')">    <!-- Giuseppe, A.Orina, A.Cricca, A.Fabbri, Massimo Buti -->
              <tei:lb />
